    ...
    <div class="services-grid">
        ...
        <div class="service-card" id="transport">
            <div class="service-image">
                <img src="assets/services/.jpg" alt="Transport et Dédouanement" onerror="this.parentElement.innerHTML='<div class=\'service-icon\'>🚢</div>'">
            </div>
        ...
        <div class="service-card" id="negoce">
            <div class="service-image">
                <img src="assets/services/negoce.jpg" alt="Négoce International" onerror="this.parentElement.innerHTML='<div class=\'service-icon\'>🌍</div>'">
            </div>
            <div class="service-content">
        ...
        <div class="service-card" id="voyages">
            <div class="service-image">
                <img src="assets/services/voyages.jpg" alt="Voyages d'Affaires" onerror="this.parentElement.innerHTML='<div class=\'service-icon\'>✈️</div>'">
            </div>
            <div class="service-content">
        ...
        <div class="service-card" id="billetterie">
            <div class="service-image">
                <img src="assets/services/billetterie.jpg" alt="Billetterie Aérienne" onerror="this.parentElement.innerHTML='<div class=\'service-icon\'>🎫</div>'">
            </div>
            <div class="service-content">
        ...
        <div class="service-card" id="visa">
            <div class="service-image">
                <img src="assets/services/visa.jpg" alt="Assistance Visa" onerror="this.parentElement.innerHTML='<div class=\'service-icon\'>📋</div>'">
            </div>
            <div class="service-content">
        ...
        <div class="service-card" id="conseil">
            <div class="service-image">
                <img src="assets/services/conseil.jpg" alt="Conseil Logistique" onerror="this.parentElement.innerHTML='<div class=\'service-icon\'>📊</div>'">
            </div>
            <div class="service-content">
...
<section style="background: var(--primary-light); text-align: center;">
    ...
    <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
        ...
        <a href="tel:+237690232217" class="cta-button" style="background: var(--white); color: var(--primary); border: 1px solid var(--primary);">Nous Appeler</a>
    </div>
</section>
